    ...
    return (
        <div className="flex min-h-screen py-2">
            ...
            <div className="grid grid-cols-2 grid-rows-8 gap-2 items-center justify-items-start my-3.5 mx-auto w-9/12 h-64 bg-blue-100 p-3.5 text-center text-gray-700 font-bold text-xl border-2 border-blue-200 rounded-lg shadow-lg">
                <h1 className="col-span-1 row-span-1 self-start">{capitalizeFirstLetter(pokemonName)}</h1>
                <FavoritesButton pokemonId={pokemon.number} pokemonName={pokemonName} className="w-64 h-12 text-center self-start justify-self-end bg-slate-400 border-slate-950 border-4 cursor-pointer rounded p-2 hover:bg-white"/>
